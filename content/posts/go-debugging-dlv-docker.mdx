...
Include this tag when building the Go binary. It preserve the debug information by disabling inlining and optimisations that can interfere with debugging so reliable debugging can be performed.
